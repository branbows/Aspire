...
class ImageSettings extends Model
{
    ...
    protected $resumePicsPath      = "public/uploads/resumes/";
    protected $defaultResumeTemplateImgpath = "public/uploads/resumes/default_resume.png";
    ...
    protected $blogImgPath             = "public/uploads/blogs/";
    protected $blogImgThumbnailpath    = "public/uploads/blogs/thumbnail/";
    protected $blogThumbnailSize    = 200;
    protected $blogImgSize          = 1200;
    protected $defaultBlogImgPath               = "public/uploads/blogs/default.jpg";
    protected $defaultBlogImgThumbnailpath      = "public/uploads/blogs/thumbnail/default.jpg";
    ...
    {
        return $this->defaultResumeTemplateImgpath;
    }
