                    ...
                    <div class="col-md-12 st-majorr">
                        <nav class="portfolio-filter text-center">
                            ...
                            <ul class="list-inline">
                                ...
                                ->where('show_in_front',1)->get()->count()}}">{{$category->category}}</a></li>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    @if ($quiz->is_paid)
                                                        <a type="button" class="btn btn-success btn-xs" href="{{ URL_START_EXAM_AFTER_LOGIN.$quiz->id }}" style="border-radius: 10px; ">Take Exam</a>
                                                    @else
                                                        <a type="button" class="btn btn-success btn-xs" href="{{URL_FRONTEND_START_EXAM.$quiz->slug}}" style="border-radius: 10px; ">Take Exam</a>
                                                    @endif
