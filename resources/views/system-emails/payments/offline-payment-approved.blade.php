 ...
 <div class="row">
    ...
    <h5 class="text-center" style="font-size:20px;font-weight:600;">{{getPhrase('offline_payment_approved')}}</h5>
  </div>
  </div>
  ...
  <p style="font-size:20px;margin:11px 0;">Your offline payment is approved for {{$plan}}</p><br>
